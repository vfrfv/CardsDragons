...
if ( TRACE ) { TRACE( "Buttle#OnPointerClick", this ); }
                ...
                this._particle.SetActive(false);
            },
...
if ( TRACE ) { TRACE( "Card2V#OnPointerClick", this ); }
                ...
                if (UnityEngine.GameObject.op_Inequality(this._episode._armO, null)) {
...
if ( TRACE ) { TRACE( "Episode4_1#ScaleUp", this ); }
    ...
    Bridge.define("Episode4_2", {
        ...
        fields: {
            ...
            _particleSystem10: null,
            _particleSystem11: null,
...
if ( TRACE ) { TRACE( "Episode4_2#InitialiseCards", this ); }
                ...
                if (list1.Count > 0 && list2.Count > 0) {
                    UnityEngine.Debug.Log$1("\u0414\u0432\u0430 \u043b\u0438\u0441\u0442\u0430");
                    this._two = true;
                } else {
                    UnityEngine.Debug.Log$1("\u041e\u0434\u0438\u043d \u043b\u0438\u0441\u0442\u0430");
                    this._two = false;
                }
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                ...
                                case 5: {
                                    $enumerator.current = this.StartCoroutine$1(this.AnimateAttack(this._cardDracone3, this._cardEnemye4, this._particleSystem10));
                                        $step = 6;
                                        return true;
                                }
                                case 6: {
                                ...
                                case 12: {
                                    cardEnemy3 = this._cardEnemye3.GetComponent(CardEnemy);
                                ...
                                case 17: {
                                    $enumerator.current = this.StartCoroutine$1(this.AnimateAttack(this._cardDracone5.gameObject, this._cardEnemye5, this._particleSystem11));
                                        $step = 18;
                                        return true;
                                }
                                case 18: {
                                ...
                                case 23: {
                                    cardEnemy = this._cardEnemye2.GetComponent(CardEnemy);
...
if ( TRACE ) { TRACE( "Episode4_2#ReturnToOriginalPosition", this ); }
                ...
                var $enumerator = new Bridge.GeneratorEnumerator(Bridge.fn.bind(this, function () {
                    try {
                        for (;;) {
                            switch ($step) {
                                case 0: {
                                    targetWorldPos = state.OriginalParent.TransformPoint$1(state.OriginalLocalPos);
                                        this.StartCoroutine$1(this.MoveToWorldPosition(attackerRect, targetWorldPos.$clone(), 0.2));
                                        $enumerator.current = new UnityEngine.WaitForSeconds(0.2);
                                        $step = 1;
                                        return true;
                                }
                                case 1: {
                                    attackerRect.SetParent(state.OriginalParent, true);
                                        attackerRect.localPosition = state.OriginalLocalPos.$clone();
            ...
            /*Episode4_2.MoveToWorldPosition start.*/
            MoveToWorldPosition: function (rectTransform, targetWorldPos, duration) {
if ( TRACE ) { TRACE( "Episode4_2#MoveToWorldPosition", this ); }
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                case 0: {
                                    time = 0.0;
                                        startPos = rectTransform.position.$clone();
                                    $step = 1;
                                    continue;
                                }
                                case 1: {
                                ...
                                case 2: {
                                    rectTransform.position = new pc.Vec3().lerp( startPos, targetWorldPos, time / duration );
                                        time += UnityEngine.Time.unscaledDeltaTime;
                                        $enumerator.current = null;
                                        $step = 3;
                                        return true;
                                ...
                                case 4: {
                                    rectTransform.position = targetWorldPos.$clone();
            ...
            /*Episode4_2.MoveToWorldPosition end.*/
