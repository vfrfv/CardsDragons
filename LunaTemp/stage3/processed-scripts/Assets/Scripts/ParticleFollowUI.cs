...
{
    public RectTransform _buttonButtle;             // UI-элемент (например, кнопка)
    public RectTransform _buttonShop;               // Второй UI-элемент
    public Camera uiCamera;                         // Камера, указанная в Canvas
    public ParticleSystem _particleEffectButton;    // Particle System для первой кнопки
    public ParticleSystem _particleEffectButtonShop;// Particle System для второй кнопки
    public float zOffset = 1.0f;                    // Смещение от камеры
