...
public class Episode4 : MonoBehaviour, IPointerClickHandler, IEventSystemHandler
{
	[SerializeField]
	private GameObject _cardDragcone1_1;

	[SerializeField]
	private GameObject _cardDragcone2_2;

	[SerializeField]
	private GameObject _cardDragcone;

	[SerializeField]
	private GameObject _arm3_3;
